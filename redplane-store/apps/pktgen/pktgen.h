...
DEFINE_bool(m_lat, false, "Measure per-packet processing latency");
DEFINE_uint32(threads, 1, "Number of workers");
DEFINE_string(filename, "", "Pcap filename");
DEFINE_string(destip, "198.19.10.0", "Destination IP address");
...
//static const uint8_t kDestMacAddr[6] = {0x28, 0x99, 0x3a, 0x73, 0x37, 0x6d}; // ToR2
//static const uint8_t kDestMacAddr[6] = {0x98,0x5d,0x82,0x9c,0xef,0xb5}; // ToR3
static const uint8_t kDestMacAddr[6] = {0x28,0x99,0x3a,0x9f,0xe7,0x5d}; // ToR3
//static const uint8_t kDestMacAddr[6] = {0x28, 0x99, 0x3a, 0x73, 0xbc, 0xf9}; // ToR1
// Globals
