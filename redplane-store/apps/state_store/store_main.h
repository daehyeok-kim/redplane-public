...
DEFINE_bool(m_lat, false, "Measure per-request processing latency");
DEFINE_bool(chain, false, "Chain replication");
...
static const std::string kPrimaryIpAddr = "198.19.11.0";
static const std::string kBackupIpAddr = "198.19.12.0";
