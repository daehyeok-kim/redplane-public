...
DEFINE_bool(chain, false, "Enabling chain replication");
DEFINE_string(nextip, "198.19.11.1", "Next node's IP");
DEFINE_string(tailip, "198.19.13.0", "Tail node's IP");

static constexpr uint16_t kChainUDPPort = 9000;
...
static const uint8_t kDestMacAddr[6] = {0x28, 0x99, 0x3a, 0x73, 0x37, 0x6d};
