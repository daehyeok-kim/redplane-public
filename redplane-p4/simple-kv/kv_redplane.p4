...
#include "nat.p4" // NAT P4 we want to make fault-tolerant
...
control Ingress(
    ...
    Nat_Ingress() Nat_Ingress; // Instantiate the original application 
    ...
    apply {
        ...
        if (ig_md.is_renew_req == true) { 
            ...
            Nat_Ingress.apply(hdr, ig_md, ig_intr_md, ig_prsr_md, ig_dprsr_md, ig_tm_md);
        } 
