...
#include "load_balance.p4" // LB P4 we want to make fault-tolerant
...
control Ingress(
    ...
    Lb_Ingress() Lb_Ingress; // Instantiate the original application 
    ...
    apply {
        ...
        if (ig_md.is_renew_req == true) { 
            ...
            Lb_Ingress.apply(hdr, ig_md, ig_intr_md, ig_prsr_md, ig_dprsr_md, ig_tm_md);
        } 
