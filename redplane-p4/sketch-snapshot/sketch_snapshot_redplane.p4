...
control Ingress(
    ...
    CM_Ingress() CM_ig; // Instantiate the original application 
    ...
    apply {
        ...
        if (ig_md.is_renew_req == false) { 
            // App's ingress logic.
            // hdr.tstamp.out_time = ig_intr_md.ingress_mac_tstamp;
            CM_ig.apply(hdr, ig_md, ig_intr_md, ig_prsr_md, ig_dprsr_md, ig_tm_md);
        } 
