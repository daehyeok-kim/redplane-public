...
header redplane_req_h {
    ...
    bit<16> seq_num; // 2
    flow_key_t flow_key; //6
    flow_value_t values; //6
}

const bit<16> REDPLANE_REQ_IP_LEN = 20 + 8 + 15;
const bit<16> REDPLANE_REQ_UDP_LEN = 8 + 15;
...
const bit<16> REDPLANE_ACK_IP_LEN = 20 + 8 + 9;
